...
**multi-agent-bridge** は、複数の Claude Code インスタンスを同時に実行し、宇宙世紀の艦隊編制のように統率するシステムである。
...
[ZIPダウンロード](https://github.com/yohey-w/multi-agent-bridge/archive/refs/heads/main.zip) して `C:\tools\multi-agent-bridge` に展開

*または git を使用:* `git clone https://github.com/yohey-w/multi-agent-bridge.git C:\tools\multi-agent-bridge`
